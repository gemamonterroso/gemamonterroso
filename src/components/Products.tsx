...
const products = [
  ...
  { img: p2, name: "Galletas surtidas", price: "Q20", desc: "Mix de galletas con chips, granillo y rellenos artesanales." },
  { img: p3, name: "Mini cupcakes", price: "Q30", desc: "6 Bocados esponjosos con buttercream de vainilla y chocolate." },
  { img: p1, name: "Bolitas de coco", price: "Q15", desc: "2 Bombones suaves cubiertos de coco rallado, tradicionales y dulces." },
  { img: p5, name: "Alboroto", price: "Q5", desc: "Crocante, dulce y festivo, perfecto para compartir." },
  { img: p6, name: "Dulces de leche", price: "Q5", desc: "Receta de la casa a base de leche fresca." },
  { img: p7, name: "Dulce de manía", price: "Q10", desc: "Dulce artesanal de maní molido." },
  { img: p8, name: "Mazapán de manía", price: "Q6", desc: "Manía triturada con endulzantes, en su forma clásica circular." },
];
